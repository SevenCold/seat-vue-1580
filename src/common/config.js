module.exports = {
    operators: [{name: '包含在其中', value: 'in'}, {name: '大于', value: '>'}, {name: '大于等于', value: '>='}, {name: '小于', value: '<'}, {name: '小于等于', value: '<='},
        {name: '等于', value: '='}, {name: '不等于', value: '!='}, {name: '以..开头', value: 'startWith'},
        {name: '不超过..小时', value: 'inTime'}, {name: '超过..小时', value: 'outTime'}],
    props: [{name: '跨', value: 'cross_id'}, {name: '取样类型', value: 'sample_type'}, {name: '材料形状', value: 'material_type'}, {name: '钢种', value: 'coil_grade'}, {name: '包装方式', value: 'packing'}, {name: '生产时间', value: 'product_time'},
    ...
    types: [{name: '普通规则', value: '0', tip: '具体指需指定'}, {name: '缓冷坑规则', value: '1', tip:'具体值从缓冷坑表中查询'}],
}