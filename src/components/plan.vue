<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter="getDataList()">
      <el-form-item>
        <el-input v-model="dataForm.key" placeholder="天车编号" clearable></el-input>
      </el-form-item>
      <el-form-item>
...
<!--      </el-table-column>-->
      ...
      <el-table-column
        ...
        <template #default="scope">
          <el-switch :value="scope.row.canedit === 1" disabled> </el-switch>
        </template>
      </el-table-column>
      <el-table-column
        prop="enable"
...
<script>
  import AddOrUpdate from './plan-update'
    ...
    methods: {
      ...
      deleteHandle (id) {
        this.$confirm(`确定删除操作?`, '提示', {
          ...
          axios.post(`/rule/plan/delete/${id}`).then((data) => {
