<template>
  <el-dialog
    ...
    <el-form :model="dataForm" inline :rules="dataRule" ref="dataForm" @keyup.enter="dataFormSubmit()">
      <el-form-item label="父规则ID" prop="parentId"  label-width="120px">
        <el-input v-model="dataForm.parentId" placeholder="父规则id" :disabled="disableParentId"></el-input>
      </el-form-item>
      <el-form-item label="规则名称" prop="name"  label-width="120px">
      ...
      <el-form-item label="规则类型" prop="ruleType" label-width="120px" class="prop-select">
      ...
      <el-form-item label="是否默认规则" v-if="dataForm.ruleType === '0'" prop="isDefault"  label-width="120px">
