<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter="getDataList()">
      <el-form-item>
        <el-input v-model="dataForm.key" placeholder="钢种名称" clearable></el-input>
      </el-form-item>
      <el-form-item>
...
<script>
  import AddOrUpdate from './slow-cool-update'
    ...
    methods: {
      ...
      deleteHandle (id) {
        this.$confirm(`确定删除操作?`, '提示', {
          ...
          axios.post(`/cool/delete/${id}`).then(data => {
